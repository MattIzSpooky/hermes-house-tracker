...
class ListingServiceSearchTest {
    ...
    void findAll_withNonEmptyParams_usesSpecificationPath() {
        var params = new ListingSearchParams("Teststraat", null, null, null, null, null, null, null, null, null, null);
    ...
    void listingSearchParams_isEmpty_trueWhenAllBlank() {
        var params = new ListingSearchParams("", " ", null, "", null, null, null, null, null, null, null);
    ...
    void listingSearchParams_isEmpty_falseWhenMinBedroomsSet() {
        var params = new ListingSearchParams(null, null, null, null, null, null, 2, null, null, null, null);
        assertThat(params.isEmpty()).isFalse();
    }

    @Test
    void listingSearchParams_isEmpty_falseWhenMinLivingAreaSet() {
        var params = new ListingSearchParams(null, null, null, null, null, null, null, null, 80, null, null);
        assertThat(params.isEmpty()).isFalse();
    }
}
